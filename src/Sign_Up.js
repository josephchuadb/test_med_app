            ...
            <div className="signup-form">
                <form>
                    ...
                    <div className="form-group">
                        ...
                        <input type="tel" name="phone" id="phone" title="Only accepts 10 digits for this phone number." required className="form-control" placeholder="Enter your phone number" aria-describedby="helpId" pattern="[1-9]{1}[0-9]{9}" />
                    </div>
